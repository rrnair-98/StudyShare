...
//    ServerAccountController serverAccountController;
   ...
   DisplayYourIp yourIp;
    ...
    FXMLLoader manageUserLoader,manageGroupLoader,shareLoader,recentLoader,
    scrollableRecentLoader;
    ...
    private void initDefaultHolder(){
        ...
        defaultHolderTitle.setAlignment(Pos.TOP_LEFT);
        defaultHolderTitle.setFont(Font.font(15));
